...
class PastriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pastry" do
    assert_difference('Pastry.count') do
      post pastries_url, params: { pastry: { description: @pastry.description, image: @pastry.image, name: @pastry.name, price: @pastry.price } }
    end
  ...
  test "should update pastry" do
    patch pastry_url(@pastry), params: { pastry: { description: @pastry.description, image: @pastry.image, name: @pastry.name, price: @pastry.price } }
